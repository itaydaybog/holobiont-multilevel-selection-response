...
import numpy as np
import MLS_static_fast_original as mlssf
...
# set folder
data_folder = Path("Original_Data/")
fig_Folder = Path("Original_figures/")
figureName = 'data_Figure3_original.pdf'
dataName = 'data_Figure3_original.npz'
...
def plot_3D(ax, data1D, sigmaIndex):
    ...
    # original plotting-
    # ax.scatter(x, y, z, c=z, s=0.3, alpha=1, vmin=0, vmax=1, cmap='plasma')
